...
func TestFetches(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			desc:              "AV1 clear media segment",
			url:               "testpic_2s_av1/av1/300.m4s?nowMS=610000",
			params:            "",
			wantedStatusCode:  http.StatusOK,
			wantedContentType: `video/mp4`,
		},
		{
			desc:              "AV1 encrypted init segment cbcs",
			url:               "testpic_2s_av1/av1/init.mp4",
			params:            "eccp_cbcs/",
			wantedStatusCode:  http.StatusOK,
			wantedContentType: `video/mp4`,
		},
		{
			desc:              "AV1 encrypted media segment cbcs",
			url:               "testpic_2s_av1/av1/300.m4s?nowMS=610000",
			params:            "eccp_cbcs/",
			wantedStatusCode:  http.StatusOK,
			wantedContentType: `video/mp4`,
		...
		{
			desc:              "AV1 encrypted media segment cenc",
			url:               "testpic_2s_av1/av1/300.m4s?nowMS=610000",
			params:            "eccp_cenc/",
			wantedStatusCode:  http.StatusOK,
			wantedContentType: `video/mp4`,
