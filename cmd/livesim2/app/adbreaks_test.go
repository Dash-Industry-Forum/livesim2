...
func TestParseAdBreaks(t *testing.T) {
	cases := []struct {
		...
		{desc: "periodic with extra breaks", spec: "p60:20,30:15", err: `svta periodic "p60:20,30:15": bad duration`},
		{desc: "periodic without duration", spec: "p60", err: `svta periodic "p60" must be p<period>:<dur>[@<off>,...]`},
		{desc: "periodic with offsets", spec: "p60:10@10,40", want: AdBreaks{
			Periodic: &AdBreakPeriodic{PeriodS: 60, DurationS: 10, OffsetsS: []int{10, 40}}}},
		{desc: "periodic offset bad", spec: "p60:10@x", err: `svta periodic "p60:10@x": bad offset "x"`},
		{desc: "periodic offsets overlap", spec: "p60:10@10,15",
			err: `svta periodic "p60:10@10,15": offsets must increase by at least the duration`},
		{desc: "periodic offsets out of cycle", spec: "p60:10@55", err: `svta periodic "p60:10@55": last break does not fit in the period`},
