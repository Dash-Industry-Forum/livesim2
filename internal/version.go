...
var (
	commitVersion string = "v1.4.1"     // Should be updated during build
	commitDate    string = "1716895409" // commitDate in Epoch seconds (can be filled/updated in during build)
)
