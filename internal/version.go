...
var (
	commitVersion string = "v1.1.1"     // Should be updated during build
	commitDate    string = "1705658256" // commitDate in Epoch seconds (can be filled/updated in during build)
)
